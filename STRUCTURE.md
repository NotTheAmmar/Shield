...
7.  **Metadata Extractor (`shield-metadata-extractor`)**: An asynchronous worker service that consumes processing queues to extract Exif data and details from uploaded media evidence.
